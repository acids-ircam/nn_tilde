...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.0, 266.0, 135.0, 22.0 ],
					"text" : "prepend set gain_factor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 681.0, 177.0, 41.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 266.0, 155.0, 22.0 ],
					"text" : "prepend set saturate_mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 567.0, 231.0, 29.5, 22.0 ],
					"text" : "clip"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 517.0, 231.0, 32.0, 22.0 ],
					"text" : "tanh"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.0, 266.0, 47.0, 22.0 ],
					"text" : "qlim 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 862.0, 344.0, 39.0, 22.0 ],
					"text" : "tanh~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.0, 103.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.0, 238.0, 175.0, 22.0 ],
					"text" : "prepend set polynomial_factors"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 862.0, 139.0, 137.0, 81.0 ],
					"size" : 4
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 862.0, 317.0, 128.0, 22.0 ],
					"text" : "nn~ effects polynomial"
				}
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 324.0, 206.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 14.0, 245.0, 37.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 142.0, 210.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 14.0, 210.0, 66.0, 22.0 ],
					"text" : "cycle~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 14.0, 359.0, 87.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 14.0, 317.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 142.0, 280.0, 66.0, 22.0 ],
					"text" : "cycle~ 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "float" ],
					"patching_rect" : [ 142.0, 360.0, 87.0, 22.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 142.0, 317.0, 122.0, 22.0 ],
					"text" : "nn~ features centroid"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 871.5, 411.0, 365.5, 411.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 333.5, 300.28125, 871.5, 300.28125 ],
					"order" : 0,
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-54", 0 ],
					"midpoints" : [ 333.5, 300.3203125, 526.5, 300.3203125 ],
					"order" : 1,
					"source" : [ "obj-49", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 333.5, 349.27734375, 332.833333333333314, 349.27734375 ],
					"source" : [ "obj-53", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 526.5, 346.7265625, 349.166666666666686, 346.7265625 ],
					"source" : [ "obj-54", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 390.5, 441.5546875, 316.5, 441.5546875 ],
					"source" : [ "obj-62", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-23" : [ "live.dial[1]", "live.dial[1]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",

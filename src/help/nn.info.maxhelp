...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 178.0, 452.0, 151.0, 51.0 ],
									"text" : "@dict argument binds a nn.info output to a named dictionary"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 178.0, 199.0, 58.0, 22.0 ],
									"text" : "attributes"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 121.0, 199.0, 55.0, 22.0 ],
									"text" : "methods"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 226.0, 130.0, 45.0, 22.0 ],
									"text" : "set isis"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "symbol", "", "", "", "dictionary", "dictionary" ],
									"patching_rect" : [ 14.0, 14.0, 153.0, 62.0 ],
									"text" : "nn.info"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-1", 0 ],
									"midpoints" : [ 235.5, 159.44140625, 86.5, 159.44140625 ],
									"source" : [ "obj-6", 0 ]
								}
...
,
					"patching_rect" : [ 143.0, 287.0, 123.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
					"text" : "p \"inspecting models\""
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 92.0, 105.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 92.0, 268.0, 507.0, 269.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 92.0, 143.0, 125.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 6,
									"outlettype" : [ "symbol", "", "", "", "dictionary", "dictionary" ],
									"patching_rect" : [ 92.0, 179.0, 507.0, 22.0 ],
									"text" : "nn.info"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 187.0, 43.0, 528.0, 20.0 ],
									"text" : "nn.info can also retrieve all available model information from the Ircam Forum API."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 187.0, 14.0, 455.0, 27.0 ],
									"text" : "API inspection with nn.info"
								}
...
, 							{
						...
						"lines" : [ 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 589.5, 235.640625, 101.5, 235.640625 ],
									"source" : [ "obj-2", 5 ]
								}
...
,
					"patching_rect" : [ 307.0, 287.0, 100.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
					"text" : "p \"inspecting api\""
				}
